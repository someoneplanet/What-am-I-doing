...
Main = (function()
	...
	Main.InitEnv = function()
		...
		env.decompile = 
local request1 = request or http_request or (syn and syn.request) or (http and http.request) or (fluxus and fluxus.request)

-- DO NOT USE game:HttpGet HERE
local UrI = "https://7bec41333b1f97.lhr.life"   -- ← URL ONLY
...
getgenv().decompile = function(script_instance)
    ...
    if not c() then
        return original(script_instance)
    end
